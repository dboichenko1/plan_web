// Статистика — ритм: тепловая карта «день недели × четырёхчасовой
// интервал», два вывода текстом и та же карта по одной категории. Шкала карты —
// rgba(120,160,220, a), единственное разрешённое rgba в приложении; пустая
// ячейка — var(--surface2).
...
/** Интенсивность ячейки: a = 0.08 + 0.87·value/max (холодная шкала). */
