      ...
      >
        <div className="mt-[150px]">
          ...
          <div className="mt-5 flex max-w-[320px] flex-col gap-1.5 text-13 text-text-quiet">
            ...
            <p>3. На iPhone на экран «Домой» добавляется именно эта страница (Поделиться → «На экран "Домой"»), лучше до входа. Ссылка из письма — только ключ, её никуда добавлять не надо.</p>
          </div>
        </div>
